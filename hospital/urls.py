...
urlpatterns = [
    ...
    path("medicine,",include('home.urls')),
    path("doctor,",include('home.urls')),
    path("patient,",include('home.urls')),
    path("online,",include('home.urls')),
    path("appointment,",include('home.urls')),
    path("emergency,",include('home.urls')),
    path("ambulance,",include('home.urls')),
